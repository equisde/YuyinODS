...
#      when YUYINODS_ENABLE_EXPERIMENTAL_JETSON=1, with
...
#      when YUYINODS_ENABLE_EXPERIMENTAL_JETSON=1.
#
...
# ----------------------------------------------------------------------------
FIXTURE_DIR="$(mktemp -d -t yuyinods-jetson-fixture-XXXXXX)"
...
YUYINODS_UNAME_M="aarch64" \
YUYINODS_NV_TEGRA_RELEASE="$FIXTURE_DIR/nv_tegra_release" \
YUYINODS_DEVICE_TREE_COMPATIBLE="$FIXTURE_DIR/dt_compatible" \
YUYINODS_DEVICE_TREE_MODEL="$FIXTURE_DIR/dt_model" \
YUYINODS_GPU0_SYSFS="$FIXTURE_DIR/gpu.0" \
YUYINODS_DRM_SYS="$FIXTURE_DIR/empty-drm" \
    detect_gpu || true
...
YUYINODS_ENABLE_EXPERIMENTAL_JETSON=1 \
YUYINODS_UNAME_M="aarch64" \
YUYINODS_NV_TEGRA_RELEASE="$FIXTURE_DIR/nv_tegra_release" \
YUYINODS_DEVICE_TREE_COMPATIBLE="$FIXTURE_DIR/dt_compatible" \
YUYINODS_DEVICE_TREE_MODEL="$FIXTURE_DIR/dt_model" \
...
YUYINODS_UNAME_M="x86_64" \
YUYINODS_NV_TEGRA_RELEASE="/dev/null/does-not-exist" \
YUYINODS_DEVICE_TREE_COMPATIBLE="/dev/null/does-not-exist" \
YUYINODS_DEVICE_TREE_MODEL="/dev/null/does-not-exist" \
YUYINODS_GPU0_SYSFS="/dev/null/does-not-exist" \
YUYINODS_DRM_SYS="$FIXTURE_DIR/empty-drm" \
    detect_gpu || true
