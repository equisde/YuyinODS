...
TEST_HOME="$(mktemp -d -t yuyinods-openclaw-XXXXXXXX)"
...
OPTIN_HOME="$(mktemp -d -t yuyinods-openclaw-optin-XXXXXXXX)"
...
FIXTURE_DIR="$(mktemp -d -t yuyinods-openclaw-fix-XXXXXXXX)"
