...
#
# Usage: ./yuyinods/tests/test-docker-image-pull-retry.sh
# ==========================================================================
...
export YUYINODS_DOCKER_PULL_MAX_ATTEMPTS=4
export YUYINODS_DOCKER_PULL_RETRY_DELAYS="1 2"
rm -f "$DOCKER_MOCK_STATE_FILE" "$SLEEP_LOG"
if run_pull_with_progress "$TMP_DIR/docker-always-timeout" "img" "label"; then
  print_fail "(unexpected success)"
else
...
unset YUYINODS_DOCKER_PULL_MAX_ATTEMPTS YUYINODS_DOCKER_PULL_RETRY_DELAYS SLEEP_LOG
