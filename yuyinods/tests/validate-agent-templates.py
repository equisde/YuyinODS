...
YUYINODS_REQUIRE_AGENT_TEMPLATE_SERVER=1 to make that condition a hard failure.
"""
...
LLAMA_SERVER_URL = os.environ.get("YUYINODS_AGENT_TEMPLATE_BASE_URL", "http://localhost:8080")
MODEL = os.environ.get("YUYINODS_AGENT_TEMPLATE_MODEL", "qwen2.5-32b-instruct")
...
def main() -> int:
    ...
    if not server_available():
        ...
        if os.environ.get("YUYINODS_REQUIRE_AGENT_TEMPLATE_SERVER") == "1":
            print(f"[FAIL] {message}")
            return 1
        print(f"[SKIP] {message}")
        print("Set YUYINODS_REQUIRE_AGENT_TEMPLATE_SERVER=1 to make this a hard failure.")
        return 0
