...
android_target="$(YUYINODS_PLATFORM_OVERRIDE=android-termux bash -c 'source installers/dispatch.sh; resolve_installer_target')"
ios_target="$(YUYINODS_PLATFORM_OVERRIDE=ios-ashell bash -c 'source installers/dispatch.sh; resolve_installer_target')"
linux_target="$(YUYINODS_PLATFORM_OVERRIDE=linux bash -c 'source installers/dispatch.sh; resolve_installer_target')"
