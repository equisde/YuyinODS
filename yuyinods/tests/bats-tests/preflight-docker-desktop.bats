...
setup() {
    ...
    # The helper file lives in yuyinods/installers/macos/lib/.
...
@test "docker-desktop sharing: 'not shared from the host' is reported as not OK" {
    _make_docker_stub "docker: Error response from daemon: error while creating mount source path '/Volumes/X/yuyinods': mkdir /Volumes/X/yuyinods: not shared from the host and is not known to Docker." 1
...
@test "docker-desktop sharing: case-insensitive 'file sharing' phrase is detected" {
    ...
    _make_docker_stub "ERROR: Filesharing is not configured for the path /Users/test/yuyinods" 1
