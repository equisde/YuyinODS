...
setup() {
    export HOME="/tmp/yuyinods-dispatch-test-home"
    unset YUYINODS_PLATFORM_OVERRIDE TERMUX_VERSION PREFIX TERM_PROGRAM ASHELL SHORTCUTS
...
@test "detect_platform: supports explicit override" {
    export YUYINODS_PLATFORM_OVERRIDE="android-termux"
...
@test "resolve_installer_target: routes a-Shell to the mobile installer" {
    export YUYINODS_PLATFORM_OVERRIDE="ios-ashell"
...
@test "resolve_installer_target: keeps desktop Linux on install-core" {
    export YUYINODS_PLATFORM_OVERRIDE="linux"
...
@test "detect_platform: treats non-gnu Linux OSTYPE values as Linux" {
    unset YUYINODS_PLATFORM_OVERRIDE
    OSTYPE="linux"
