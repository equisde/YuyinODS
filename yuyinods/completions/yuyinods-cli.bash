#!/bin/bash
# Bash completion for yuyinods-cli
...
_ods_completion() {
    ...
    # Service names (from yuyinods-cli aliases section)
        ...
        2)
            case $prev in
                ...
                restore)
                    ...
                    local backup_dir="${YUYINODS_HOME:-$HOME/yuyinods}/.backups"
                ...
                preset|p)
                    case $prev in
                        save|load|delete)
                            ...
                            local preset_dir="${YUYINODS_HOME:-$HOME/yuyinods}/.presets"
...
complete -F _ods_completion ./yuyinods-cli

# Also register for common installation paths
complete -F _ods_completion ~/yuyinods/yuyinods-cli
complete -F _ods_completion /opt/yuyinods/yuyinods-cli