...
| [Build On ODS](../docs/BUILD-ON-YuyinODS-SERVER.md) | How to fork ODS, ship a custom edition, keep changes rebase-friendly, and validate downstream changes |
...
- **Build a custom edition**: [Build On ODS](../docs/BUILD-ON-YuyinODS-SERVER.md)
