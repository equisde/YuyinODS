...
from config import SERVICES, INSTALL_DIR, DATA_DIR, LLM_BACKEND, AGENT_URL, YUYINODS_AGENT_KEY
...
async def _check_tailscale_health(service_id: str, config: dict) -> ServiceStatus:
    ...
    try:
        ...
        headers = {"Authorization": f"Bearer {YUYINODS_AGENT_KEY}"} if YUYINODS_AGENT_KEY else {}
