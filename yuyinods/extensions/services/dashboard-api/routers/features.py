...
async def feature_enable_instructions(
    ...
    ods_proxy_url = _svc_url("yuyinods-proxy")

    instructions = {
        "lan-web": {
            "steps": [
                "Enable the yuyinods-proxy extension from Extensions, or run: ods enable yuyinods-proxy",
                "Start or restart ODS so yuyinods-proxy listens on port 80",
