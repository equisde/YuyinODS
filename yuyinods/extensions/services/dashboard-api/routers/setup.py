...
from config import SERVICES, PERSONAS, SETUP_CONFIG_DIR, INSTALL_DIR, AGENT_URL, YUYINODS_AGENT_KEY
...
async def run_setup_diagnostics(api_key: str = Depends(verify_api_key)):
    ...
    script_path = Path(INSTALL_DIR) / "scripts" / "yuyinods-test-functional.sh"
    if not script_path.exists():
        script_path = Path(os.getcwd()) / "yuyinods-test-functional.sh"
...
#
# These are thin proxies in front of yuyinods-host-agent. Network mutation needs
