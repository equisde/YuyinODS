...
class TestFetchContainerStats:
    ...
    def test_valid_json_response(self):
        ...
        containers = [{"container_name": "yuyinods-llama", "cpu_percent": 45.0}]
...
class TestServiceResources:
    ...
    def test_full_response_with_stats_and_disk(self, test_client, monkeypatch):
        ...
        fake_services = {
            "llama-server": {"name": "Llama Server", "container_name": "yuyinods-llama"},
            "open-webui": {"name": "Open WebUI", "container_name": "yuyinods-webui"},
        }
        monkeypatch.setattr("routers.resources.SERVICES", fake_services)
        monkeypatch.setattr("routers.resources.GPU_BACKEND", "nvidia")

        fake_stats = [
            {"container_name": "yuyinods-llama", "cpu_percent": 45.0, "memory_used_mb": 1024},
            {"container_name": "yuyinods-webui", "cpu_percent": 10.0, "memory_used_mb": 256},
        ]
        fake_disk = {
    ...
    def test_restart_service_calls_host_agent(self, test_client, monkeypatch):
        ...
        monkeypatch.setattr("routers.resources.SERVICES", {
            "ape": {"name": "APE", "container_name": "yuyinods-ape"},
        })
    ...
    def test_restart_dashboard_uses_delayed_host_agent_restart(self, test_client, monkeypatch):
        ...
        monkeypatch.setattr("routers.resources.SERVICES", {
            "dashboard-api": {"name": "Dashboard API", "container_name": "yuyinods-dashboard-api"},
        })
