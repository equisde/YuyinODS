...
os.environ.setdefault("YUYINODS_INSTALL_DIR", "/tmp/yuyinods-test-install")
os.environ.setdefault("YUYINODS_DATA_DIR", "/tmp/yuyinods-test-data")
os.environ.setdefault("YUYINODS_EXTENSIONS_DIR", "/tmp/yuyinods-test-extensions")
