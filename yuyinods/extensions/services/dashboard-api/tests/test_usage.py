...
def test_usage_readiness_reports_ready_token_spy(test_client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda: {
            "source": "builtin",
            "path": "/yuyinods/extensions/services/token-spy",
            "installed": True,
            "enabled": True,
            "disabled": False,
            "compose_file": "/yuyinods/extensions/services/token-spy/compose.yaml",
...
def test_usage_readiness_reports_disabled_token_spy_with_enable_action(test_client, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda: {
            ...
            "disabled": True,
            "compose_file": None,
            "disabled_compose_file": "/yuyinods/extensions/services/token-spy/compose.yaml.disabled",
        },
    )
