...
|-----------|-------|------|
| `yuyinods-langfuse-web` | `langfuse/langfuse:3.159.0` | Web UI and API (port 3006) |
| `yuyinods-langfuse-worker` | `langfuse/langfuse-worker:3.159.0` | Async event processing |
| `yuyinods-langfuse-postgres` | `postgres:17.9-alpine` | Relational store |
| `yuyinods-langfuse-clickhouse` | `clickhouse/clickhouse-server:26.2.4.23` | Analytics store |
| `yuyinods-langfuse-redis` | `redis:7.4.8-alpine` | Job queue |
| `yuyinods-langfuse-minio` | `minio/minio` | Object store for event uploads |
