...
#
# Hook contract (see bin/yuyinods-host-agent.py:_handle_install):
...
chown_dir "$POSTGRES_DIR" "70:70" "yuyinods-langfuse-postgres"

# clickhouse-server image: uid 101 (clickhouse user)
chown_dir "$CLICKHOUSE_DIR" "101:101" "yuyinods-langfuse-clickhouse"
