...
YUYINODS_ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
[[ -f "$YUYINODS_ROOT/lib/safe-env.sh" ]] && . "$YUYINODS_ROOT/lib/safe-env.sh"
...
export AGENT_SESSION_DIRS="${AGENT_SESSION_DIRS:-'{\"openclaw\":\"~/yuyinods/data/openclaw/home/agents/main/sessions\"}'}"
