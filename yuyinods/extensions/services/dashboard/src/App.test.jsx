...
vi.mock('./pages/YuyinODSTalk', () => ({
  default: () => <div data-testid="yuyinods-talk">ODS Talk Portal</div>,
}))
...
describe('App', () => {
  beforeEach(() => {
    ...
    globalThis.localStorage.removeItem('yuyinods-sidebar-collapsed')
    globalThis.sessionStorage.removeItem('yuyinods-splash-shown')
  ...
  test('renders ODS Talk without dashboard chrome on /talk', async () => {
    ...
    expect(await screen.findByTestId('yuyinods-talk')).toBeInTheDocument()
    expect(document.querySelector('aside')).not.toBeInTheDocument()
