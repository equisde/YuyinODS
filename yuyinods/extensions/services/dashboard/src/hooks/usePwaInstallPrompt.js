...
const VISIT_COUNT_KEY = 'yuyinods-pwa-visit-count'
const SESSION_TICKED_KEY = 'yuyinods-pwa-session-ticked'
const DISMISSED_KEY = 'yuyinods-pwa-prompt-dismissed'
const INSTALLED_KEY = 'yuyinods-pwa-installed'
