...
const YuyinODSTalk = lazy(() => import('./pages/YuyinODSTalk'))
...
function App() {
  ...
  // Auto-mint a yuyinods-session cookie on load so the install owner can
  ...
  const [splashDone, setSplashDone] = useState(
    () => getStorageValue(globalThis.sessionStorage, 'yuyinods-splash-shown') === '1'
  )
  ...
  const [sidebarCollapsed, setSidebarCollapsed] = useState(() => {
    return getStorageValue(globalThis.localStorage, 'yuyinods-sidebar-collapsed') === 'true'
  })

  useEffect(() => {
    setStorageValue(globalThis.localStorage, 'yuyinods-sidebar-collapsed', String(sidebarCollapsed))
  }, [sidebarCollapsed])
      ...
      <div className="min-h-screen bg-theme-bg text-theme-text">
        <Suspense fallback={
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-sm text-theme-text-muted">Opening YuyinODS Talk...</div>
          </div>
        }>
          <YuyinODSTalk />
        </Suspense>
    ...
    return (
      <div className="min-h-screen bg-theme-bg text-theme-text">
        {!splashDone && <SplashScreen onComplete={() => {
          setStorageValue(globalThis.sessionStorage, 'yuyinods-splash-shown', '1')
          setSplashDone(true)
        }} />}
        <Suspense fallback={
          <div className="min-h-screen flex items-center justify-center">
            <div className="font-mono text-sm text-theme-accent tracking-widest animate-pulse">YuyinODS</div>
          </div>
        }>
