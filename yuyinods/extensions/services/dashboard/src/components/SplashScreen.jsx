...
export default function SplashScreen({ onComplete }) {
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="yuyinods-splash-title"
      aria-describedby="yuyinods-splash-status yuyinods-splash-hint"
      onClick={skip}
      style={{
    ...
    >
      ...
      <div style={{
        ...
        <h1 id="yuyinods-splash-title" style={{ position: 'relative', userSelect: 'none', margin: 0 }}>
