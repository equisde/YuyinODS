    ...
    solutions: [
      {
        ...
        command: 'ls -lh ~/yuyinods/data/models/',
    ...
    solutions: [
      {
        ...
        command: 'cd ~/yuyinods && docker compose up -d whisper tts',
    ...
    <div className="space-y-4">
      ...
      <div className="pt-3 border-t border-theme-border">
        <p className="text-xs text-theme-text-muted">
          ...
          <a
            href="https://github.com/equisde/YuyinODS/tree/main/yuyinods#troubleshooting"
            target="_blank"
          ...
          {' '}or run{' '}
          <code className="bg-theme-card px-1 py-0.5 rounded text-theme-text-muted">./scripts/yuyinods-test.sh</code>
        </p>
      </div>
    </div>
  )
