...
const SERVICE_LINK_ALIASES = {
  ...
  'yuyinods-proxy': ['yuyinods-proxy', 'ods server web', 'ods web proxy'],
}
...
const FEATURE_LAUNCH_FALLBACKS = {
  ...
  'lan-web': { type: 'service', service: 'yuyinods-proxy' },
...
const OVERVIEW_HISTORY_KEY = 'yuyinods-system-overview-history-v1'
const SERVICE_CPU_HISTORY_KEY = 'yuyinods-service-cpu-history-v1'
