...
|--------|-------------|-----------------|
| `yuyinods-doctor.sh` | JSON diagnostic report with autofix hints | No |
| `yuyinods-preflight.sh` | Pre-install hardware/software checks | No |
...
| Script | Description | Requires Stack? |
|--------|-------------|-----------------|
| `yuyinods-test.sh` | Full validation (`--quick`, `--json`, `--service`) | Yes |
| `yuyinods-test-functional.sh` | Functional tests (inference, TTS, STT) | Yes |
