#!/bin/bash
# yuyinods-preflight.sh — Quick health check before first chat
# Usage: ./scripts/yuyinods-preflight.sh
...
LLM_CONTAINER="${SERVICE_CONTAINERS[llama-server]:-yuyinods-llama-server}"
