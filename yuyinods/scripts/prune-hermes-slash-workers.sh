...
collect_workers() {
    if [[ -n "${YUYINODS_HERMES_SLASH_WORKER_PS_FIXTURE:-}" ]]; then
        cat "$YUYINODS_HERMES_SLASH_WORKER_PS_FIXTURE"
        return 0
    fi
