...
the `yuyinods/` product root and bare filenames
...
| Debug a broken install | [YuyinODS-DOCTOR.md](YuyinODS-DOCTOR.md) | [INSTALL-TROUBLESHOOTING.md](INSTALL-TROUBLESHOOTING.md), [SUPPORT-BUNDLE.md](SUPPORT-BUNDLE.md) |
...
| Build a custom edition or fork | [FORKABILITY.md](FORKABILITY.md) | [RELEASE_CHANNELS.md](RELEASE_CHANNELS.md), [BUILD-ON-YuyinODS-SERVER.md](BUILD-ON-YuyinODS-SERVER.md), [OFFLINE_AND_MIRRORING.md](OFFLINE_AND_MIRRORING.md), [VALIDATION_REPRODUCIBILITY.md](VALIDATION_REPRODUCIBILITY.md) |
...
| Operator guide | Helps users install, operate, or troubleshoot | [../QUICKSTART.md](../QUICKSTART.md), [YuyinODS-DOCTOR.md](YuyinODS-DOCTOR.md), [TROUBLESHOOTING.md](TROUBLESHOOTING.md), [POST-INSTALL-CHECKLIST.md](POST-INSTALL-CHECKLIST.md) |
...
| Deep dive | Explains a subsystem or design area | [INSTALLER-ARCHITECTURE.md](INSTALLER-ARCHITECTURE.md), [BACKEND-CONTRACT.md](BACKEND-CONTRACT.md), [YuyinODS_CLI_DECOMPOSITION.md](YuyinODS_CLI_DECOMPOSITION.md) |
...
|-----|----------|-------------|
| [HOW-YuyinODS-SERVER-WORKS.md](HOW-YuyinODS-SERVER-WORKS.md) | **Everyone** | **The friendly guide — what ODS is, why it exists, how every piece fits together, and how to make it your own. No technical background required.** |
...
| Doc | Audience | Description |
|-----|----------|-------------|
| [BUILD-ON-YuyinODS-SERVER.md](BUILD-ON-YuyinODS-SERVER.md) | Downstream builders | Forking, custom editions, source-of-truth map, extension compatibility, and validation checklist |
...
| [YuyinODS_CLI_DECOMPOSITION.md](YuyinODS_CLI_DECOMPOSITION.md) | Maintainers / CLI contributors | Behavior-preserving plan for splitting the large Bash operator CLI without a risky rewrite |
...
| [YuyinODS-DOCTOR.md](YuyinODS-DOCTOR.md) | Operators | Diagnostic tool usage |
