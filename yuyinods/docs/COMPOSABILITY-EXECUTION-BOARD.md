...
- [`get-yuyinods.sh`](../get-yuyinods.sh)
...
- `scripts/yuyinods-doctor.sh` now emits prioritized autofix hints from preflight/runtime findings.
...
- `manifest.json` (new)
- [`dashboard-api/main.py`](../extensions/services/dashboard-api/main.py)
- [`yuyinods-update.sh`](../yuyinods-update.sh)
Acceptance:
...
- Added `scripts/yuyinods-doctor.sh` and `docs/YuyinODS-DOCTOR.md` for machine-readable readiness diagnostics (capability + preflight + runtime snapshot).
