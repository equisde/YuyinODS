...
```bash
./yuyinods-macos.sh status          # Health checks for all services
./yuyinods-macos.sh stop            # Stop everything
./yuyinods-macos.sh start           # Start everything
./yuyinods-macos.sh restart         # Restart everything
./yuyinods-macos.sh logs llama-server   # Tail llama-server logs
```
...
| What | Where |
|------|-------|
| Install directory | `~/yuyinods/` |
| Config | `~/yuyinods/.env` |
| Models | `~/yuyinods/data/models/` |
| llama-server binary | `~/yuyinods/llama-server/` |
| OpenCode | `~/.opencode/bin/opencode` |
| OpenCode config | `~/.config/opencode/opencode.json` |
| LaunchAgent (OpenCode) | `~/Library/LaunchAgents/com.ods.opencode-web.plist` |
| CLI tool | `~/yuyinods/yuyinods-macos.sh` |
