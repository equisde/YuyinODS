...
| `yuyinods-cli` | High | User lifecycle, config, restart, backup, mode, and extension control | CLI smoke, `ods restart`, `ods doctor`, lifecycle lane; use [YuyinODS_CLI_DECOMPOSITION.md](YuyinODS_CLI_DECOMPOSITION.md) for behavior-preserving split work |
