...
Date: 2026-03-02
Scope: `/home/user/yuyinods` (Strix Halo variant)
...
- [x] Add ODS Doctor diagnostics report:
  - [`scripts/yuyinods-doctor.sh`](../scripts/yuyinods-doctor.sh)
  - [YuyinODS-DOCTOR.md](YuyinODS-DOCTOR.md)
...
- Why: README advertises Apache 2.0, but `/home/user/yuyinods` has no `LICENSE`.
...
- Evidence:
  - `scripts/yuyinods-preflight.sh` reports Docker not running.
  - `scripts/yuyinods-test.sh --quick` fails early (`docker not installed`).
...
./scripts/yuyinods-test.sh --quick
