...
- Installer runtime output: `/tmp/yuyinods-capabilities.json` (override with `CAPABILITY_PROFILE_FILE`)

## Generate

```bash
scripts/build-capability-profile.sh --output /tmp/yuyinods-capabilities.json
```
