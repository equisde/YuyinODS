...
```bash
git clone --mirror https://github.com/equisde/YuyinODS.git
cd ODS.git
...
```bash
YUYINODS_DOCKER_PULL_MAX_ATTEMPTS=4 YUYINODS_DOCKER_PULL_RETRY_DELAYS="10 30 60" ./install.sh
```
