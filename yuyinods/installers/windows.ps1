#!/usr/bin/env pwsh
<#
YuyinODS Windows installer (WSL2-delegated MVP).
...
param(
    ...
    [string]$Distro = "",
    [string]$ReportPath = "$env:TEMP\\yuyinods-windows-preflight.json",
...
Write-Host "YuyinODS Windows installer (WSL2 path)" -ForegroundColor Cyan
