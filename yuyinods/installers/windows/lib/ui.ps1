# ============================================================================
# YuyinODS Windows Installer -- UI Helpers
# ============================================================================
...
"@
    ...
    Write-Host "  YuyinODS Windows Installer v$($script:YUYINODS_VERSION)" -ForegroundColor White
...
function Write-Phase {
    ...
    Write-Host ""
    Write-Host "  YUYINODS SEQUENCE [$elapsed]" -ForegroundColor DarkGray -NoNewline
...
function Write-SuccessCard {
    ...
    $_bindAddr = ""
    $_envPath = Join-Path $script:YUYINODS_INSTALL_DIR ".env"
    ...
    Write-Host ".\yuyinods.ps1 logs llama-server" -ForegroundColor Cyan
    Write-Host "       Stop:       " -ForegroundColor DarkGray -NoNewline
    Write-Host ".\yuyinods.ps1 stop" -ForegroundColor Cyan
    Write-Host ""
