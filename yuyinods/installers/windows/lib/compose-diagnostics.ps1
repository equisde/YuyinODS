...
function Write-ODSComposeFailureReport {
    ...
    @(
        ...
        "- YUYINODS_MODE=$(Get-ODSComposeEnvValue -InstallDir $InstallDir -Name "YUYINODS_MODE" -Default "unknown")",
...
function Write-ODSComposeDiagnostics {
    ...
    Write-AI "Docs: yuyinods/docs/WINDOWS-TROUBLESHOOTING-GUIDE.md (section: Docker Compose failed)"
    Write-Host ""
