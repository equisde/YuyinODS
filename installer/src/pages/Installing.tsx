...
export default function Installing({
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-8">
      <h2 className="text-2xl font-bold mb-2">Installing YuyinODS</h2>
      ...
      <div className="w-full max-w-md mb-4">
        <div className="h-3 bg-gray-800 rounded-full overflow-hidden">
          <div
            className="h-full bg-gradient-to-r from-yuyinods-600 to-yuyinods-400 rounded-full transition-all duration-700"
