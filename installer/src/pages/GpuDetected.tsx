  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-8">
      ...
      <div className="bg-gray-900 rounded-xl p-6 mb-6 w-full max-w-md text-center">
        <p className="text-xs text-yuyinods-400 uppercase tracking-wider mb-2">
      ...
      {!hasGpu && (
        <p className="text-sm text-gray-500 mb-6 text-center max-w-sm">
          No dedicated GPU detected. YuyinODS will use cloud AI providers
