...
Thanks for wanting to contribute. YuyinODS is open source and we welcome help from everyone — whether you're fixing a bug, adding a service integration, or tackling a full feature.
...
Building on YuyinODS for a hardware appliance, lab image, vertical bundle,
or downstream distribution? Start with
**[yuyinods/docs/FORKABILITY.md](yuyinods/docs/FORKABILITY.md)** and
**[yuyinods/docs/BUILD-ON-YuyinODS-SERVER.md](yuyinods/docs/BUILD-ON-YuyinODS-SERVER.md)**.
...
**[yuyinods/docs/HIGH_RISK_CHANGE_MAP.md](yuyinods/docs/HIGH_RISK_CHANGE_MAP.md)**
...
High-risk surfaces such as installer phases, `yuyinods-cli`, Compose generation,
...
See
**[yuyinods/docs/AI_WORKFLOW_GUARDRAILS.md](yuyinods/docs/AI_WORKFLOW_GUARDRAILS.md)**
...
**[yuyinods/CONTRIBUTING.md](yuyinods/CONTRIBUTING.md)**
...
Not sure about something? Open a thread in [GitHub Discussions](https://github.com/equisde/YuyinODS/discussions) or an issue. We're happy to help you figure out the right approach before you write code.
